...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype.init = function () {
		...
		element.on("change", function(e) { 
			...
			var _previewImg = $(el).parent().find(previewImg);
			if(file) {
